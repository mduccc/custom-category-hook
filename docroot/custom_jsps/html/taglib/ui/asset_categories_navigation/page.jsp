...
<link rel="stylesheet" href="/html/taglib/ui/asset_categories_navigation/css/custom.css">
...
<liferay-ui:panel-container cssClass="taglib-asset-categories-navigation" extended="<%= true %>" id='<%= namespace + "taglibAssetCategoriesNavigationPanel" %>' persistState="<%= true %>">
	...
	%>
			...
			<liferay-ui:panel collapsible="<%= false %>" extended="<%= false %>" persistState="<%= true %>" title="">
